 ...
 *
 * Authorization required: login as same user or isAdmin = true
 **/
...
router.patch("/:username", ensureAdminOrTargetUser, async function (req, res, next) {
  try {
...
router.post("/:username/jobs/:id", ensureAdminOrTargetUser, async function (req, res, next) {
  try {
